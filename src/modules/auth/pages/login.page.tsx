...
export const LoginPage = async () => {
  ...
  return (
    <Box tag="main" className="flex justify-center h-screen bg-primary-50">
      <Box className="hidden md:flex grow max-w-2xl h-full items-center justify-center">
        <img
          src="/login-image.svg"
          alt="Imagen ilustrativa de inicio de sesión"
          className="w-full"
        />
      </Box>
      ...
      <Box
        tag="section"
        className="flex flex-col justify-center items-center w-full md:max-w-lg"
      >
        <Box className="w-full h-[90%] flex justify-center items-center">
          <Box className="flex flex-col">
            <Box tag="header" className="mb-6">
        ...
        <Box tag="footer" className="mt-4 flex justify-end">
          <Link
